...
```bash
$ git clone git@github.com:<yourname>/easy-inn-booking-platform.git
```

#### 添加 easy-inn-booking-platform 仓库
...
# 例如：
$ git remote add example git@github.com:KieNoe/easy-inn-booking-platform.git
```
